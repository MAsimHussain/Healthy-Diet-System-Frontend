...
export default function ViewPatient() {
  ...
  const [userWithIssuee, setUserWithIssuee] = useState([]);
  ...
  useEffect(() => {
    ...
    if (localData) {
      ...
      debugger
      const id = userData.pId;

      const HendleViewPatient = async () => {
        try {
          const res = await apiService.GetUsersByNutritionist(id);

          setUserWithIssuee(res);
        } catch (error) {
          navigate("/*");
            ...
            >
              ...
              <div className="py-4 px-6">
                ...
                <div className="flex items-center mt-4 text-gray-700">
                  ...
                  <h1
                    onClick={() => replayPatient(item.userProfileId)}
