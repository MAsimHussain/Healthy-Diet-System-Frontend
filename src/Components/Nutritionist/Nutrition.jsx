...
export default function Nutrition() {
  const [nutritionist, setNutritionists] = useState({});
  ...
  useEffect(() => {
    ...
    if (localData) {
      ...
      const getNutritionists = async () => {
        try {
          const res = await apiService.GetNutritionistOwnData(
            {
    ...
    <>
      ...
      <div className="m-3 md:w-[27%] w-full bg-white shadow-lg rounded-lg my-4">
        ...
        <div className="py-4 px-6">
          ...
          <p className="py-2 text-lg text-gray-700">{nutritionist.age}</p>
          ...
          <div className="flex items-center mt-4 text-gray-700">
            ...
            <h1 className="px-2 text-sm">{nutritionist.email}</h1>
          </div>
          <div className="flex items-center mt-4 text-gray-700">
            <svg className="h-6 w-6 fill-current" viewBox="0 0 512 512">
              <path d="M437.332 80H74.668C51.199 80 32 99.198 32 122.667v266.666C32 412.802 51.199 432 74.668 432h362.664C460.801 432 480 412.802 480 389.333V122.667C480 99.198 460.801 80 437.332 80zM432 170.667L256 288 80 170.667V128l176 117.333L432 128v42.667z" />
            </svg>
            <h1 className="px-2 text-sm">{nutritionist.lastName}</h1>
          </div>
          <div className="flex items-center mt-4 text-gray-700">
            <svg className="h-6 w-6 fill-current" viewBox="0 0 512 512">
              <path d="M437.332 80H74.668C51.199 80 32 99.198 32 122.667v266.666C32 412.802 51.199 432 74.668 432h362.664C460.801 432 480 412.802 480 389.333V122.667C480 99.198 460.801 80 437.332 80zM432 170.667L256 288 80 170.667V128l176 117.333L432 128v42.667z" />
